...
const login_button = <button class='login' id='login_button' onClick={() => make_account()}>SignUp</button>
...
function make_account(){
    ...
    fetch(`/new_account?login=${login}&password=${password}`, {
        method: "GET",
